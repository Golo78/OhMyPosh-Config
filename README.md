...
This tutorial is primarily based on a [Microsoft tutorial](https://learn.microsoft.com/en-us/windows/terminal/tutorials/custom-prompt-setup) but includes additional information, eliminating the need for further research.
